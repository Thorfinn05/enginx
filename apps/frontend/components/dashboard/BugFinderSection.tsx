        ...
        <div className="relative grid gap-8 lg:grid-cols-[1fr_minmax(0,360px)] lg:items-center">
          ...
          >
            ...
            <ul className="mt-4 space-y-1.5 font-mono text-xs text-cream/55">
              <li className="flex items-center gap-2">
                ...
                Filter by concept or play across all topics
              </li>
              <li className="flex items-center gap-2">
                <span className="w-1 h-1 bg-amber-400 rounded-full" />
                Points sync like the quiz arena
              </li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <motion.button
              ...
              type="button"
              onClick={() => start()}
              className="mt-5 w-full rounded-[14px] bg-gradient-to-r from-amber-500 to-orange-500 py-3.5 font-grotesk uppercase tracking-wide text-[#010828] shadow-[0_0_24px_rgba(245,158,11,0.25)] transition-all hover:brightness-110 font-bold active:shadow-inner"
            >
              Open terminal
            </motion.button>
          </motion.div>
